...
(6, 'pest', 'Plantain moth', 'Scopula rubraria and Epyaxa rosearia', 'Consists of at least 2 species which may be difficult to differentiate. They have pale brownish to greenish forewings with wavy lines.', 'Very little is known about the biology of these moths. They are assumed to have similar life cycles to other pasture moths.', 'The caterpillars feed on the plant leaves causing windowing and notches similar to grass grub and porina damage.', 'There are no registered insecticides for control. Management relies on general pasture management.', 'Epyaxa-rosearia2_James.jpg', 'Plantain-moth-on-Moth-on-Tonic-plantain.jpeg'),
